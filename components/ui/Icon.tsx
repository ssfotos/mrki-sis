// Fix: Create Icon components for use across the application.
...
export const PurchasesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export const SuppliersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16h2a1 1 0 001-1v-3a1 1 0 00-1-1h-2M13 11H4" />
    </svg>
);
...
export const ChevronDoubleLeftIcon: React.FC<IconProps & { isCollapsed: boolean }> = ({ isCollapsed, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 transition-transform duration-300 ${isCollapsed ? 'rotate-180' : ''}`} {...props}>
